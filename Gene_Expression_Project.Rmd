...
ggplot(aes(x = x_coord, y = y_coord, color = groups, label = coldata)) + 
  geom_text(size = 3) +
  scale_colour_manual(values=c("green", "blue", "grey", "cyan", "red", "yellow"))+
  ggtitle('Multi Dimensional Scaling') +
  labs(x = "Poisson Distance", y = "Poisson Distance") +
...
>>>>>>> 259d1e1ae10292bc1a3ad5dd095e44eb5afdcc8d
>>>>>>> d979666c45ca24be7239c2e7abf9747b5582fee4
