...
Using DESeq a comparison was made between the schizophrenic patients who are on anti-psychotic medication and those who are not. A comparison was also made between the schizophrenia group who do not use medication and the healthy control group. These two comparisons were made for each hippocampal subfield using an adjusted p-value of 0.05. The results of these comparisons gives information about the amount of genes that are up or down regulated.
