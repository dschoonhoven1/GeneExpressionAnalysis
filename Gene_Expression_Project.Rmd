...
boxplot(log2(counts[control_ca3] + 1), outline = T, col = "grey", las = 2, main = "C. CA1 Control", adj = 0)
boxplot(log2(counts[case_ca3] + 1), outline = T, col = "cyan", las = 2, main = "D. CA1 Case", adj = 0)
boxplot(log2(counts[control_dg] + 1), outline = T, col = "red", las = 2, main = "E. CA1 Control", adj = 0)
boxplot(log2(counts[case_dg] + 1), outline = T, col = "yellow", las = 2, main = "F. CA1 Case", adj = 0)
```
...
```{r}
GO_data <- "GO.txt"
GO_CA3 <- read.table(file = GO_data, header = TRUE, sep = "\t", dec = ".")
head(GO_CA3)

GO_CA3$log10 <- -log10(GO_CA3$q.value.FDR.B.H)
